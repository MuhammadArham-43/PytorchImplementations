...
class AlexNet(nn.Module):
    def __init__(self, num_classes, in_channels) -> None:
        ...
        self.block1 = AlexNetBlock(in_channels, 96, 11, 4, 0)
        self.block2 = AlexNetBlock(96, 256, 5, 1, 2)
        self.block3 = AlexNetBlock(256,384, 3, 1, 1)
        self.block4 = AlexNetBlock(384,384, 3, 1, 1)
        self.block5 = AlexNetBlock(384,256, 3, 1, 1)
